...
/** Side-column reel strips — exclude influencer spotlight videos */
export const mainVideos = [...showcaseVideos];
...
/** Preload hero + influencer reels for faster first paint */
export const PRELOAD_VIDEOS = [HERO_VIDEO, ...INFLUENCER_VIDEO_SRCS] as const;
