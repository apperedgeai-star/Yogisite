...
export const JUPITER_INTRO = `Jupiter is the largest planet — it commands gravity. This service is for brands and businesses that want a complete content campaign that pulls massive attention. 50 pieces, 5 million views, done.`;
...
The logic and the 100K+ threshold stay the same. Only the headline number changes.`;
...
export const CONVERSATIONS = [
  ...
  { name: "Viplav Panghal", stat: "215K+", session: "Generative AI Sessions and Content Strategy", image: ASSETS.conversations.viplavGaurav },
  { name: "Gaurav Rawat", stat: "100K+", session: "Generative AI Sessions and Content Strategy", image: ASSETS.conversations.viplavGaurav },
  ...
  { name: "Romil Mavani", stat: "—", session: "Business Consultancy Session (Mavani Solutions IT Agency)", image: ASSETS.conversations.romilMavani },
  { name: "Undisclosed", stat: "—", session: "Travel Agency · Sales Session", image: ASSETS.conversations.kasimShaikh },
  { name: "Undisclosed", stat: "—", session: "Marketing Agency · Business Consultancy", image: ASSETS.conversations.dabhiManthan },
  { name: "Undisclosed", stat: "—", session: "Sales Session", image: ASSETS.conversations.yogiiProfile },
  { name: "Undisclosed Company", stat: "—", session: "SAAS Solution", image: ASSETS.conversations.multiSession },
] as const;

export const ADDITIONAL_COLLABORATORS = [
  "Jay Desai",
  "Kaushal Pandey",
  "Harsh K.",
  "Tanya",
...
export const FOUNDER_FACTS = [
  { label: "Track Record", short: "Roles, raises, companies", full: "Former COO and CMO with over ₹2CR raised, systems built from scratch, teams hired, investor work led, and startup operations scaled across India." },
  { label: "Master's Union", short: "35% scholarship story", full: "Cleared all three interview rounds at Master's Union, received their highest-ever scholarship offer of 35%, and declined admission to go all-in on the next venture." },
  { label: "Content Network", short: "22 touchpoints", full: "4 main accounts plus 18 fan and niche pages point audience attention back to the founder from 22 different angles every month." },
  { label: "AI Systems", short: "Clone, generative, deployment", full: "AI clone videos, generative brand content, websites, landing pages, and digital tools built to support content and distribution at scale." },
] as const;
...
export const FOUNDER_BIO = [
  ...
  `With my track record in scaling startups (two of them failed), building systems from scratch, managing high-stake growth roles, and successfully raising over ₹2CR in funding, I bring not just experience—but clarity, speed, and result-oriented leadership.`,
  `I don't just talk about growth. I engineer it.`,
  `From content systems and ad funnels to onboarding strategies and investor documentation, I've done it all—and done it under pressure.`,
