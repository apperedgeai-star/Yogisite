...
const blendLayer: CSSProperties = {
  pointerEvents: "none",
  position: "fixed",
  left: 0,
  top: 0,
...
export default function FluidCursor() {
  ...
  return (
    <>
      <canvas ref={canvasRef} style={blendLayer} aria-hidden />
      ...
      <div
        ref={ringRef}
        className="cursor-ring flex items-center justify-center font-satoshi"
        style={{
          ...blendLayer,
          width: isDrag ? 80 : 44,
          height: isDrag ? 30 : 44,
          borderRadius: isDrag ? 9999 : "50%",
          border: isLink || isVideo ? "none" : `1px solid ${GOLD}`,
          background:
            isLink || isVideo ? "rgba(232, 201, 110, 0.8)" : "transparent",
          opacity: isLink || isVideo ? 1 : 0.6,
        }}
      >
        {isLink && (
